...
\[Web\_servers]
web1 ansible\_host=192.168.1.101 ansible\_user=ubuntu
web2 ansible\_host=192.168.1.102 ansible\_user=centos
...
\
ansible-playbook -i /location/where/hostsAreStored -l web\_servers change\_password.yml
